...
from .rtqd_decoder import (
    SCMRTQDRotatedRTDETRTransformerDecoder,
)
from .scene_context_module import SceneContextModule
from .utils import build_scene_class_targets,build_scene_scale_targets,soft_scale_membership
...
class SCMRotatedRTDETR(RotatedRTDETR):
    ...
    def _init_layers(self) -> None:
        """Use baseline encoder and RTQD-aware decoder."""
    ...
    def forward_decoder(
        ...
        # Keep the original DINO zero-connected dependency.
