        ...
        **kwargs,
        ...
        if self.scne_enabled:
            ...
            self.scene_head = SceneNegativeEvidenceHead(
                ...
                num_pool_heads=int(scne_cfg["num_pool_heads"]),
                use_layer_norm=bool(scne_cfg["use_layer_norm"]),
                bottleneck_dim=(
                    None
                    if scne_cfg["bottleneck_dim"] is None
                    else int(scne_cfg["bottleneck_dim"])
                ),
                dropout=float(scne_cfg["dropout"]),
            )
        else:
