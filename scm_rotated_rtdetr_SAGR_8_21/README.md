...
SD experiment config:

- `configs/scm_o2_rtdetr_r50vd_2xb4_72e_dior_sd.py`

The config without the `_sd` suffix is the local SCM baseline and keeps the
original O2-RTDETR bbox loss.
