...
model = dict(
    ...
    bbox_head=dict(
        ...
        # RotatedRTDETRHead -> SCMSDRotatedRTDETRHead
        # ----------------------------------------------------
        type=SCMSDRotatedRTDETRHead,
        ...
        #
        # IMPORTANT:
        # inherited DN loss still calls self.loss_bbox,
        # therefore DN supervision remains identical to 8/15.
        # ----------------------------------------------------
        loss_bbox=dict(
            type=L1Loss,
            loss_weight=5.0,
        ...
        # ----------------------------------------------------
        # New normal-query / encoder-query SD bbox loss.
        #
        # scale_ref=0.12 is aligned with the 8/15 upper
        # scale boundary.
        # ----------------------------------------------------
        sd_loss_cfg=dict(
            delta=0.50,
